...
<template>
  <h1>
    <Icon name="material-symbols:featured-seasonal-and-gifts" /> Krisna-völgyi
    ajándékutalványok
  </h1>
  <h2>
    Ajándékozz élményt a Krisna-völgyben! Lepd meg szeretteidet egy különleges
    ajándékkal.
  </h2>
  <p>
    Egy belépőjeggyel, mely lehetőséget ad felfedezni a csodálatos
    Krisna-völgyet, illetve egy finom, vegetáriánus ebéddel, amely a helyi
    közösség hagyományos ételeit kínálja. Az ajándékutalvány ideális választás
    mindazoknak, akik szeretnének egy nyugodt, spirituális élményben részesülni,
    miközben kapcsolatba kerülnek a természet szépségével és a helyi kultúrával.
  </p>

  <p>
    Fedezd fel Krisna-völgyet, élvezd a finom falatokat, és tölts el egy
    felejthetetlen napot egy különleges helyen - ajándékozd meg szeretteidet egy
    valódi kikapcsolódással.
  </p>
  ...
  <form @submit.prevent="sendOrder">
    ...
    <label
      >Számlát kérek: <input v-model="invoiceNeeded" type="checkbox"
    /></label>
    ...
    <button>
      <Icon name="material-symbols:featured-seasonal-and-gifts" /> Rendelés
      elküldése
    </button>
  </form>

  <p>
    Az ajándék belépőjegyek ára az aktuális Krisna-völgyi belépőjegy árával
    egyezik meg.
  </p>

  <p>
    Az ajándék ebéd menü kártyák ára az aktuális Krisna-völgyi étterem napi menü
    árával egyezik meg.
  </p>

  <p>
    Az ajándék belépőjegyek egyszeri belépésre használhatóak fel és tartalmaznak
    vendégvezetést is az indiai szentélyben, illetve a birtok bejárását
    egyénileg.
  </p>

  <p>
    Az ajándék kártyák a kiemelt rendezvényeinken is felhasználhatóak, kivéve a
    Krisna-völgyi Búcsú 3 napja.
  </p>

  <p>
    Az ajándék kártyák vissza-, illetve készpénzre nem válthatóak, további
    értékesítésük tilos. Felhasználáskor az ajándék kártyák árából nem adható
    vissza készpénz.
  </p>
